...
public class SpringbootApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Category cat2 = new Category(null, "Smartphones");

        Product p1 = new Product(null, "TV Samnsung 53", 3590.90, cat1);
        Product p2 = new Product(null, "Home Theater LG ", 990.00, cat1);
        Product p3 = new Product(null, "Iphone 12", 9890.00, cat2);
        Product p4 = new Product(null, "Samsung M31 S ", 1560.00, cat2);
